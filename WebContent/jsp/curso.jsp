...
<html ng-app="mainApp">
  <head>
    ...
    <script src="../js/controller/cursoController.js"></script>
  ...
  <body>
    ...
    <div class="container" ng-controller="CursoController">
    	<div class="panel panel-default">
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        <div class="input-group">    
                        	...
                        	<input type="text" class="form-control" placeholder="Busque por um curso" ng-model="filterSearch">
                        </div>
                    </div>  
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <div class="input-group">
                        	<button type="button" title="Editar" ng-click="newRegister()" class="btn btn-success">
								<i class="fa fa-plus" style="padding-right: 15px;"></i>Novo curso
							</button>
                        </div>
                    </div>
                </div>
			...
			<table class="table table-hover">
				...
				<tbody>
					<tr ng-repeat="curso in cursos | filter:filterSearch">
						<td>{{curso.codigo}}</td>
						<td>{{curso.nome}}</td>
						<td>{{curso.unidade}}</td>
						<td class="text-center">
							<button type="button" title="Remover" ng-click="openRemove(curso)"class="btn btn-danger">
								<i class="fa fa-trash"></i>
							</button>
							<button type="button" title="Editar" ng-click="editRegister(curso)" class="btn btn-info">
								<i class="fa fa-pencil"></i>
							</button>
						</td>
					</tr>
					<tr ng-show="!cursos || (cursos | filter:filterSearch).length<=0">
						<td colspan="4" >
