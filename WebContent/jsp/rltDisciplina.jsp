...
<html ng-app="mainApp">
  <head>
    ...
    <script src="../js/controller/rltDisciplinaController.js"></script>
  ...
  <body ng-controller="RltDisciplinaController">
    <jsp:include page="/jsp/menuUser.jsp" />
    <div class="" >
    	<div class="panel panel-default">
			<div class="panel-heading">Relatório ordenado por disciplina</div>
