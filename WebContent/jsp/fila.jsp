  ...
  <body>
    ...
    <div class="container" ng-controller="FilaController">
    	<div class="panel panel-default">
			<div class="panel-heading">Listagem de filas</div>
				...
				<tbody>
					<tr ng-repeat="fila in filas | filter:filterSearch">
						...
						<td class="text-right" style="padding-right: 40px;">
							<button ng-show="fila.status" type="button" title="Remover todas as disciplinas com flag" ng-click="removeDisciplinasFila()"class="btn btn-danger">
								<i class="fa fa-trash"></i>
							</button>
							<button ng-show="fila.status" type="button" title="Editar fila" ng-click="editFila(fila)" class="btn btn-info">
								<i class="fa fa-pencil"></i>
							</button>
							<button ng-show="fila.status" type="button" title="Alterar posição dos professores na fila" ng-click="alteraPosicao()" class="btn btn-warning">
