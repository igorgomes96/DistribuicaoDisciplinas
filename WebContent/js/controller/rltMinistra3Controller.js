app.controller('RltMinistra3Controller',['utils','$sessionStorage', '$scope', '$http', '$location', '$routeParams', '$anchorScroll', '$timeout', '$modal',
  ...
  $scope.init = function(){
	  ...
	  $http.get(url + 'relatorio/relatFila3').success(function(response) {
		  $scope.relat = [];
